...
## 2026-09-22 - Bind inherited checkers to the canonical candidate scope

DECISION=Remove_the_stale_numeric_76_path_assumption_from_the_two_inherited_aggregate_checkers_and_compare_the_parsed_active_contract_scope_to_the_canonical_phase0_candidate_scope.
RATIONALE=The_D7_E4D_candidate_validly_expanded_the_canonical_allowlist_to_80_paths.The_first_post_release_Reviewer_proved_that_two_legacy_checkers_still_hard_coded_76_and_also_relied_on_the_old_authority_accidentally_appearing_in_the_preamble.Binding_to_the_canonical_scope_and_the_explicit_historical_provenance_record_preserves_the_original_assertions_without_requiring_future_numeric_updates.

```text
AUTHORITY_ID=OWNER_GO_D7_E4D_AGGREGATE_COMPATIBILITY_CORRECTION_V1_20260921
SCOPE=EXACT_7_PATHS
CHECKERS_CHANGED=check-exact17-local-candidate-implementation.mjs;check-source-assembly-reconciliation.mjs
CANONICAL_SCOPE_SOURCE=scripts/checkers/check-ai-governance-bootstrap.mjs_phase0CandidateScope
APPLICATION_RUNTIME_CHANGE=NONE
PRODUCTION_OR_REMOTE_ACTION=NONE
```

## 2026-09-21 - Preserve the exact job and block runtime reuse

DECISION=Use_the_existing_deterministic_job_as_the_only_recovery_target_and_do_not_reuse_the_historical_D7_E_or_D7_E4B_runtime.
RATIONALE=Fresh_bounded_evidence_proves_the_exact_Gmail_source_while_the_expected_Drive_artifacts_and_canonical_Sheet_row_are_absent;the_job_remains_VALIDATED_version_4_with_reconciliation_evidence.The_old_pilot_blocks_this_existing_job_and_omits_current_Hoa_Don_inventory_and_Gmail_projection_contracts,while_D7_E4B_is_consumed_and_assumes_external_artifacts_that_are_now_absent.

```text
AUTHORITY_ID=OWNER_GO_D7_E4D_LOCAL_ONLY_SAME_JOB_RECOVERY_ELIGIBILITY_V1_20260921
EVIDENCE_DECISION=PASS_27_OF_27
CAPABILITY_DECISION=BLOCKED_0_OF_7
JOB_DISPOSITION=PRESERVE_EXISTING_JOB_ID
REQUIRED_STATE_PATH=VALIDATED_FILES_SAVED_COMMITTING_ROWS_COMMITTED_INVENTORY_PENDING_PROJECTIONS_COMMITTED_COMPLETED
NEW_JOB_OR_ATTEMPT_GENERATION=NOT_AUTHORIZED
...
## 2026-09-20 - Implement Exact17 as one four-cluster local candidate

DECISION=AUTHORIZE_AND_BUILD_ONE_EXACT_69_PATH_LOCAL_CANDIDATE_FOR_THE_FOUR_COUPLED_EXACT17_CLUSTERS
...
TASK_ID=01a0508a-ca2d-72b0-8138-e60315864d31
IDENTITY_DECISION=NEW_COMMITS_USE_INVOICEKEYV2_AND_LINEIDENTITYV2_WITH_IMMUTABLE_TRANSACTION_SEQUENCE;LEGACY_READS_REMAIN_SUPPORTED
COMMIT_DECISION=GMAIL_SUCCESS_IS_A_PROJECTION_ONLY_AFTER_REQUIRED_ARTIFACT_LEDGER_AND_INVENTORY_VERIFICATION
INVENTORY_DECISION=ORDER_BY_ISSUE_DATE_TRANSACTION_SEQUENCE_SOURCE_LINE_NUMBER_AND_BLOCK_OVERSELL_BEFORE_WRITE
AUDIT_DECISION=RUN_SCOPED_PROGRESS_AND_SHARED_APPEND_ONLY_AUDIT;HISTORICAL_DIRECT_EDIT_REQUIRES_RECONCILIATION
COMPATIBILITY_DECISION=NO_HISTORICAL_ROW_REWRITE_AND_NO_PHYSICAL_SHEET_SCHEMA_CHANGE
BOUNDARY_DECISION=LOCAL_ONLY_NO_SOURCE_SYNC_PRODUCTION_ACCESS_MUTATION_STAGE_COMMIT_PUSH_OR_DEPLOY
CHECKPOINT_DECISION=ONLY_AFTER_FULL_ACCEPTANCE_WRITER_RELEASE_AND_INDEPENDENT_REVIEWER_VERIFIER_PASS

## 2026-09-20 - Compose historical D7-E3V gate with current governed scope

DECISION=CORRECT_THE_SINGLE_AGGREGATE_COMPATIBILITY_DEFECT_WITHIN_EXACT_11_PATHS
...
ROOT_CAUSE=D7_E3V_HISTORICAL_DIRTY_ALLOWLIST_REJECTED_VALID_CURRENT_PHASE_PATHS_BEFORE_SEMANTIC_CHECKS
POLICY_DECISION=D7_E3V_MAY_COMPOSE_ONLY_THE_GOVERNANCE_EXPORTED_PHASE0_CANDIDATE_SCOPE_AND_ITS_HISTORICAL_EXACT_PATHS
SCOPE_DECISION=ADD_ONLY_D7_E3V_CHECKER_AND_ITS_REGRESSION_TEST_TO_THE_69_PATH_CANDIDATE_ALLOWLIST_FOR_71_UNIQUE_PATHS
FAIL_CLOSED_DECISION=STAGED_OR_UNEXPECTED_DIRTY_PATHS_REMAIN_REJECTED
BOUNDARY_DECISION=NO_APPLICATION_RUNTIME_CHANGE_SOURCE_SYNC_PRODUCTION_ACCESS_MUTATION_STAGE_COMMIT_PUSH_OR_DEPLOY

## 2026-09-20 - Preserve remote-only runtime dependencies in local source assembly

DECISION=ASSEMBLE_EXACT_REMOTE_BYTES_FOR_invoiceCanonical.js_AND_SKU_ENGINE.js_AND_RESTORE_ONLY_THEIR_PROVEN_MENU_CALL_SITE
AUTHORITY_ID=OWNER_GO_LOCAL_SOURCE_ASSEMBLY_RECONCILIATION_INVOICECANONICAL_SKUENGINE_SHEETMENU_V1_20260920
RATIONALE=REMOTE_RUNTIME_CALLS_CANONICAL_INVOICE_HELPERS_AND_SKU_MENU_ENTRYPOINTS_BUT_LOCAL_CHECKPOINT_OMITTED_THEIR_DEFINITIONS
SAFETY=EXACT_REMOTE_HASHES_PINNED;SKU_PRODUCTION_COMMIT_REMAINS_DISABLED;NO_AUTOMATIC_ENTRYPOINT_EXECUTION_ADDED
SCOPE_DECISION=EXACT_17_MUTATION_PATHS_AND_76_PATH_CANDIDATE_ALLOWLIST
BOUNDARY_DECISION=NO_CLASP_PUSH_NO_GAS_NO_PRODUCTION_NO_STAGE_COMMIT_OR_GIT_PUSH
