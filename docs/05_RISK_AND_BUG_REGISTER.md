...
RISK_REMAINING=The existing malformed pilot row has not been inspected or repaired in production; the separate repair marker remains unconfigured and the repair entrypoint was not executed.
