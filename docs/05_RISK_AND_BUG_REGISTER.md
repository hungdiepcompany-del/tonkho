...
RISK_REDUCED=TEMPORARY_EXACT_REFERENCE_READ_ONLY_PRODUCTION_SMOKE_EXECUTOR_PROVEN_LOCALLY_WITH_FAKE_SERVICES
RISK_REMAINING=OWNER_MANUAL_OR_EXECUTABLE_GAS_READ_ONLY_SMOKE_NOT_YET_RUN_AND_PRODUCTION_DURABLE_STATE_NOT_ACTIVE
