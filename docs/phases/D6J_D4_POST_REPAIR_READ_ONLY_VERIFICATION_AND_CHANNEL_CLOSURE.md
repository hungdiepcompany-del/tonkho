...
D6J_D4A_UTF8_CANONICAL_HARDENING=PASS
...
If Sheet verification blocks, downstream stage statuses remain `NOT_EVALUATED`; they are not reported as failed checks.
