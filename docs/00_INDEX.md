...
NEXT_ALLOWED_BUNDLE=BUNDLE_C_SINGLE_THREAD_EXECUTOR_SOURCE_CLEANUP_GAS_PUSH_AND_EVIDENCE
...
| Bundle C-S4 Single-Thread Executor Cleanup | LOCAL_SOURCE_CLEANUP_READY_FOR_GAS_PUSH |
...
TEMPORARY_EXECUTOR_SOURCE_STATUS=REMOVED_LOCAL_PENDING_GAS_PUSH
