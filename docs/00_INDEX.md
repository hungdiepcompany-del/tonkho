...
| SGDS-CRIT-003 D4 Durable Scanner Integration Design | PASS_DURABLE_SCANNER_INTEGRATION_DESIGN |`r`n| SGDS-CRIT-003 D5A Local Durable Orchestration | PASS_LOCAL_DURABLE_ORCHESTRATION |
...
SGDS_CRIT_003_D4_STATUS=PASS_DURABLE_SCANNER_INTEGRATION_DESIGN`r`nSGDS_CRIT_003_D5A_STATUS=PASS_LOCAL_DURABLE_ORCHESTRATION
...
LOCAL_DURABLE_ORCHESTRATOR=IMPLEMENTED_FAKE_ADAPTERS_ONLY`r`nSCANNER_WIRING=NOT_STARTED
...
- [SGDS-CRIT-003 D4 Durable Scanner Integration Design](phases/SGDS_CRIT_003_D4_DURABLE_SCANNER_INTEGRATION_DESIGN.md)`r`n- [SGDS-CRIT-003 D5A Local Durable Orchestration](phases/SGDS_CRIT_003_D5A_LOCAL_DURABLE_ORCHESTRATION.md)
