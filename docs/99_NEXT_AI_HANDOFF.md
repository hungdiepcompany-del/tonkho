...
LATEST_SOURCE_COMMIT=23f493dffba9c4178a4fb9dd1cebcc7f84b2b196
...
NEXT_AI_FIRST_ACTION=Owner reruns the D6J-D read-only malformed-row audit entrypoint after the date canonicalization and safe malformed-row locator fix is synced. Do not configure the D6J-D repair marker and do not execute the repair entrypoint until the audit result is reviewed and owner grants explicit repair approval.
