...
NEXT_ALLOWED_PHASE=OWNER_REVIEW_AND_EXPLICIT_EXECUTION_APPROVAL
NEXT_AI_FIRST_ACTION=Finish D6J-C2 full validation, commit, push to GitHub, perform one normal clasp push without --force, then prove remote source by isolated clasp pull. Do not configure D6J_C_MUTATION_APPROVAL_MARKER and do not execute runD6jCOneRecordProductionMutation.
