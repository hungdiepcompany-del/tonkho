...
NEXT_AI_FIRST_ACTION=Owner reruns the D6J-D read-only malformed-row audit entrypoint after the Vietnamese header canonicalization fix is synced. Do not configure the D6J-D repair marker and do not execute the repair entrypoint until the audit result is reviewed and owner grants explicit repair approval.
