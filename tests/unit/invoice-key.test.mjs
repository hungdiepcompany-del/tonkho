...
const TEST_METADATA = defineTestMetadata({ testClass: 'CURRENT_BEHAVIOR', sourceFiles: ['Shared_Normalization.js', 'normalization.js', 'sheetHoaDon.js'], ownerPolicyRequired: false, runtimeMutation: 'NONE' });
const gas = loadGasSource({
  files: ['Shared_Normalization.js', 'normalization.js', 'sheetHoaDon.js'],
