...
const TEST_METADATA = defineTestMetadata({ testClass: 'CURRENT_BEHAVIOR', sourceFiles: ['Shared_Normalization.js', 'normalization.js', 'xmlParser.js'], ownerPolicyRequired: false, runtimeMutation: 'NONE' });
const sheet = {
  getLastRow: () => 3,
  getRange: () => ({ getValues: () => [['THEPTAM', 'THÉP TẤM MẪU'], ['THEPCUON', 'THÉP CUỘN MẪU']] }),
};
const gas = loadGasSource({
  files: ['config.js', 'Shared_Normalization.js', 'normalization.js', 'xmlParser.js'],
